...
Le matrici di confusione mostrano che le classi più riconsociute per il modello \textit{XGBoost}, in ordine sono \textit{Virus},\
...
Tuttavia, anche in questo caso, come nel dataset precedente, si osserva una tendenza comune dei classificatori ad ettichettare erronemanete come \textit{Trojan} \
diversi esempi apparteneti in realtà ad altre classi.\
Questo evidenzia, ancora una volta, la difficoltà nell'individuare un comportamento comune e distintivo per la classe \textit{Troajn}.\
