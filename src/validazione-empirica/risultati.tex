...
%%%%%%%%%%%%% Inizio metriche APIMDS %%%%%%%%%%%%%%%
%%%%%%%%%%%%% Random Forest %%%%%%%%%%%%%%%%%%%%%%%%

\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/apimds-RandomForest-precision.svg}
    }
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/apimds-RandomForest-recall.svg}
    }
    \caption{\prcdescription{apimds}{RandomForest}{Recall}}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/apimds-RandomForest-f1_score.svg}
    }
    \caption{\prcdescription{apimds}{RandomForest}{F1-score}}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/apimds-XGBoost-f1_score.svg}
    }
    \caption{\prcdescription{apimds}{XGBoost}{Precision}}
    \label{fig:apimds-xgb-prc}
\end{figure}

\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/apimds-XGBoost-recall.svg}
    }
    \caption{\prcdescription{apimds}{XGBoost}{Recall}}
    \label{fig:apimds-xgb-rc}
\end{figure}
...
\begin{figure}[]
    ...
    \caption{\prcdescription{apimds}{XGBoost}{F1-score}}
    \label{fig:apimds-xgb-f1}
\end{figure}

\FloatBarrier

%%%%%%%%%%%%%%% FINE METRICHE CLASSE APIMDS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/octak-RandomForest-precision.svg}
    }
    \caption{\prcdescription{octack}{RandomForest}{Precision}}
    \label{fig:octack-rf-prc}
\end{figure}

\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/octak-RandomForest-recall.svg}
    }
    \caption{\prcdescription{octack}{RandomForest}{Recall}}
    \label{fig:octack-rf-rc}
\end{figure}

\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/octak-RandomForest-f1_score.svg}
    }
    \caption{\prcdescription{octack}{RandomForest}{F1-score}}
    \label{fig:octack-rf-f1}
\end{figure}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/octak-XGBoost-f1_score.svg}
    }
    \caption{\prcdescription{octack}{XGBoost}{Precision}}
    \label{fig:octack-xgb-prc}
\end{figure}

\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/octak-XGBoost-recall.svg}
    }
    \caption{\prcdescription{octack}{XGBoost}{Recall}}
...
\begin{figure}[]
    ...
    \caption{\prcdescription{octack}{XGBoost}{F1-score}}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/mpasco-RandomForest-precision.svg}
    }
    \caption{\prcdescription{mpasco}{RandomForest}{Precision}}
    \label{fig:mpasco-rf-prc}
\end{figure}

\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/mpasco-RandomForest-recall.svg}
    }
    \caption{\prcdescription{mpasco}{RandomForest}{Recall}}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/mpasco-RandomForest-f1_score.svg}
    }
    \caption{\prcdescription{mpasco}{RandomForest}{F1-score}}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/mpasco-XGBoost-f1_score.svg}
    }
    \caption{\prcdescription{octack}{XGBoost}{Precision}}
    \label{fig:mpasco-rf-prc}
\end{figure}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/mpasco-XGBoost-recall.svg}
    }
    \caption{\prcdescription{octack}{XGBoost}{Recall}}
    \label{fig:mpasco-rf-rc}
\end{figure}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/quovadis-RandomForest-precision.svg}
    }
    \caption{\prcdescription{quovadis}{RandomForest}{Precision}}
    \label{fig:apimds-rf-prc}
\end{figure}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/quovadis-RandomForest-recall.svg}
    }
    \caption{\prcdescription{quovadis}{RandomForest}{Recall}}
    \label{fig:apimds-rf-rc}
\end{figure}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/quovadis-RandomForest-f1_score.svg}
    }
    \caption{\prcdescription{quovadis}{RandomForest}{F1-score}}
    \label{fig:apimds-rf-f1}
\end{figure}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/quovadis-XGBoost-f1_score.svg}
    }
    \caption{\prcdescription{quovadis}{XGBoost}{Precision}}
    \label{fig:apimds-rf-prc}
\end{figure}
...
\begin{figure}[]
    \centering
    \adjustbox{max width=1.4\linewidth, max height=2\textheight}{%
        \includesvg[width=\textwidth]{validazione-empirica/imgs/quovadis-XGBoost-recall.svg}
    }
    \caption{\prcdescription{quovadis}{XGBoost}{Recall}}
    \label{fig:apimds-rf-rc}
\end{figure}
...
\begin{figure}[]
    ...
    \caption{\prcdescription{quovadis}{XGBoost}{F1-score}}
    \label{fig:apimds-rf-f1}
\end{figure}
