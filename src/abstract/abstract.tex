...
con l'obiettivo di classificare automaticamente le diverse famiglie di malware sfruttando tecniche di Machine Learning supervisionato.
...
I risultati sperimentali evidenziano una maggiore efficacia del classificatore \textit{RandomForest}, che ha dimostrato una superiore capacità di generalizzazione e stabilità rispetto a \textit{XGBoost}, in particolare nella gestione di dataset sbilanciati e nell'identificazione delle classi minoritarie.
