...
Tale approccio ha permesso di trasformare le sequenze di chiamate API in vettori numerici - chiamati \textit{Feature Vector} - basati sulla frequenza delle invocazioni API, ignorando l'ordine temporale.
