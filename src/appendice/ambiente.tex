...
Inoltre, grazie alla compatibilità nativa con lo standard Dev Container\mycite{devspec}, il repository può essere aperto direttamente via browser tramite \textbf{GitHub Codespaces}\mycite{codespaces}, permettendo di sviluppare ed eseguire il codice in un ambiente cloud pre-configurato senza alcuna installazione locale.