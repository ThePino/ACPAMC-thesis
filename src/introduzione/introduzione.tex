...
A tale scopo, Windows utilizza il formato \texttt{PE} (Portable Executable),\
così denominato in quanto progettato per non essere vincolato a una specifica architettura\cite{Microsoft-PE}.
